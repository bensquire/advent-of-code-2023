...
describe('Advent of code day 2a', () => {
	...
	test('can calculate a code with 2 games, where in one game the scores are out of bounds', () => {
		const output = solve("Game 1: 1 green, 20 blue; 2 red\nGame 2: 1 green, 2 blue; 2 red")
